...
nsROCSSPrimitiveValue::GetCssText(nsAString& aCssText)
{
  ...
  switch (mType) {
    case CSS_PX :
      {
        float val = NSTwipsToFloatPixels(mValue.mAppUnits, mT2P);
	  ...
	  case CSS_CM :
      {
        float val = NS_TWIPS_TO_CENTIMETERS(mValue.mAppUnits);
        tmpStr.AppendFloat(val);
    ...
    case CSS_MM :
      {
        float val = NS_TWIPS_TO_MILLIMETERS(mValue.mAppUnits);
        tmpStr.AppendFloat(val);
    ...
    case CSS_IN :
      {
        float val = NS_TWIPS_TO_INCHES(mValue.mAppUnits);
        tmpStr.AppendFloat(val);
    ...
    case CSS_PT :
      {
        float val = NSTwipsToFloatPoints(mValue.mAppUnits);
        tmpStr.AppendFloat(val);
  ...
  *aReturn = 0;
  ...
  switch(aUnitType) {
    case CSS_PX :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NSTwipsToFloatPixels(mValue.mAppUnits, mT2P);
      break;
    case CSS_CM :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NS_TWIPS_TO_CENTIMETERS(mValue.mAppUnits);
      break;
    case CSS_MM :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NS_TWIPS_TO_MILLIMETERS(mValue.mAppUnits);
      break;
    case CSS_IN :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NS_TWIPS_TO_INCHES(mValue.mAppUnits);
      break;
    case CSS_PT :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NSTwipsToFloatPoints(mValue.mAppUnits);
      break;
    case CSS_PC :
      if (mType != CSS_PX)
        return NS_ERROR_DOM_INVALID_ACCESS_ERR;
      *aReturn = NS_TWIPS_TO_PICAS(mValue.mAppUnits);
      break;
    case CSS_PERCENTAGE :
